...
class Categoria(models.Model):  # Models de Usuario
...
class Funcionario(models.Model):
  ...
  usuario = models.ForeignKey(
      User, on_delete=models.PROTECT)  # Models de Usuario
...
class Veiculo(models.Model):
  ...
  cadastrado_em = models.DateTimeField(auto_now_add=True)  # Models de Usuario
...
class Usuario():
  name = models.CharField(max_length=50, verbose_name="Qual é o nome do Usuario ?", help_text="Exemplo: Fulado de tal")
...
# class Cidade(models.Model):
#     nome = models.CharField(max_length=50)
#     estado = models.CharField(max_length=2)   // Codigo Antigo
...
#   nascimento = models.DateField(verbose_name='Data de nascimento')
#   email = models.EmailField(max_length=100)  # ja ira validar o EMAIL
#   contato = models.IntegerField(verbose_name='Numero de celular:',
#                                 help_text="Exemplo: 44997253416", validators=[MaxValueValidator(15)])
#   cidade = models.ForeignKey(Cidade, on_delete=models.PROTECT)
...
#       max_length=50, verbose_name="Qual é o veiculo ?", help_text="Exemplo: Mazda RX7")
#   data = models.DateField(verbose_name='Data do veiculo',
#                           help_text="Exemplo: 06/02/2014")
#   cor = models.CharField(max_length=20, verbose_name="Qual a cor do veiculo ?",
#                          help_text="Exemplo: Vermelho, Prata, Preto...")
#   diaria = models.IntegerField(
#       verbose_name="Qual o valor da diaria do veiculo ?", help_text="Exemplo: 150, 200, 500 ...")
#   qtn_bancos = models.IntegerField(
#       verbose_name="Qual a quantidade de bancos do veiculo ?", help_text="Exemplo: 3, 4, 5 ...", validators=[MaxValueValidator(8)])
#   gasto_gasolina_km = models.IntegerField(verbose_name="Quanto que o veiculo gasta de gasolina por KM ?",
#                                           help_text="Exemplo: 3, 4, 5 ...", validators=[MaxValueValidator(10), MinValueValidator(1)])
#   modelo_motor = models.CharField(
#       max_length=20, verbose_name="Qual o modelo do motor ?")
#   velocidade_max = models.CharField(
#       max_length=50, verbose_name="Qual a velocidade maxima do veiculo ?")
...
#       max_length=50, verbose_name="Qual é o nome do Usuario ?", help_text="Exemplo: Fulado de tal")
